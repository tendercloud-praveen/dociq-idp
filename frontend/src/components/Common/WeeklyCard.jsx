...
//         <div>
//           <h2 className="font-bold text-lg text-slate-800">Weekly Report</h2>

//           <p className="text-sm text-slate-500">
//             Last 7 days document statistics
//           </p>
//         </div>
//       </div>
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="font-bold text-xl text-slate-800">Weekly Report</h2>
